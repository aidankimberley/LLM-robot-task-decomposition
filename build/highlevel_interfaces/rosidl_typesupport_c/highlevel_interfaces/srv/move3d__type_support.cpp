...
static const _Move3d_Request_type_support_symbol_names_t _Move3d_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, highlevel_interfaces, srv, Move3d_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, highlevel_interfaces, srv, Move3d_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, highlevel_interfaces, srv, Move3d_Request)() {
  return &::highlevel_interfaces::srv::rosidl_typesupport_c::Move3d_Request_message_type_support_handle;
}
...
static const _Move3d_Response_type_support_symbol_names_t _Move3d_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, highlevel_interfaces, srv, Move3d_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, highlevel_interfaces, srv, Move3d_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, highlevel_interfaces, srv, Move3d_Response)() {
  return &::highlevel_interfaces::srv::rosidl_typesupport_c::Move3d_Response_message_type_support_handle;
}
...
static const _Move3d_Event_type_support_symbol_names_t _Move3d_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, highlevel_interfaces, srv, Move3d_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, highlevel_interfaces, srv, Move3d_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, highlevel_interfaces, srv, Move3d_Event)() {
  return &::highlevel_interfaces::srv::rosidl_typesupport_c::Move3d_Event_message_type_support_handle;
}
...
static const _Move3d_type_support_symbol_names_t _Move3d_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, highlevel_interfaces, srv, Move3d)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, highlevel_interfaces, srv, Move3d)),
  }
};
...
static const rosidl_service_type_support_t Move3d_service_type_support_handle = {
  ...
  &Move3d_Request_message_type_support_handle,
  &Move3d_Response_message_type_support_handle,
  &Move3d_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, highlevel_interfaces, srv, Move3d)() {
  return &::highlevel_interfaces::srv::rosidl_typesupport_c::Move3d_service_type_support_handle;
}
